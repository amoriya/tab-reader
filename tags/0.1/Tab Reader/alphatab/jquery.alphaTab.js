...
(function($)
{
    alphaTabWrapper = function(el, options)
    {
        ...
        this.canvas = $('<canvas id="tab0" width="'+(window.innerWidth)+'" height="'+this.options.height+'" class="alphaTabSurface"></canvas>');
        ...
        this.tablature.updateScale((navigator.userAgent.match('iPhone')!=null)?0.66:1.0);
